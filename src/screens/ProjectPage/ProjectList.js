  ...
  RenderTableComponent = ({ item }) => {
    return (
      ...
      <View style={{width:'90%',margin:'5%',shadowColor:res.color.lightGrayColor,alignSelf:'center'}}>
        <TouchableOpacity style={{width:'100%',alignItems:'center',justifyContent:'center'}} onPress={() => this.onPressCell(item)}>
        <View style={{alignItems:'center',width:'100%'}}>
        <Image style={{width:'100%',height: 300,resizeMode:'contain'}} source={{
